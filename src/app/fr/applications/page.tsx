...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: { "en-US": "/applications", "fr-CA": "/fr/applications" },
  },
  openGraph: { url: "/fr/applications", title: "Applications", description, locale: "fr_CA" },
};

export default function FrApplicationsIndex() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...subpageJsonLd({ name: "Applications", description, path: "/fr/applications" }),
            inLanguage: "fr-CA",
          }).replace(/</g, "\\u003c"),
        }}
      />
      <section className="bg-graphite-950 pb-14 pt-24 lg:pt-28">
        <Container>
          ...
          <p className="mt-10 max-w-3xl text-[13px]/[1.7] text-white/50">
            ...
            disponible{" "}
            <Link href="/applications" className="font-semibold text-brand-400">en anglais</Link>.
          </p>
        </Container>
      </section>
    </>
