...
import { FR_COMPLIANCE } from "@/lib/data/fr-compliance";
import { subpageJsonLd } from "@/lib/schema";

const description =
  "Classification des emplacements dangereux : classes, divisions, groupes et concepts de protection. Traduction en attente de révision par un spécialiste en sécurité francophone.";

export const metadata: Metadata = {
  robots: { index: false, follow: false },
  title: "Conformité | Classification des emplacements dangereux",
  description,
  alternates: {
    canonical: "/fr/conformite",
    languages: { "en-US": "/hazardous-locations", "fr-CA": "/fr/conformite" },
  },
  openGraph: { url: "/fr/conformite", title: "Conformité", description, locale: "fr_CA" },
};

export default function FrComplianceIndex() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...subpageJsonLd({ name: "Conformité", description, path: "/fr/conformite" }),
            inLanguage: "fr-CA",
          }).replace(/</g, "\\u003c"),
        }}
      />
      <section className="bg-graphite-950 pb-14 pt-24 lg:pt-28">
        <Container>
          ...
          <p className="mt-10 max-w-3xl text-[13px]/[1.7] text-white/50">
            ...
            disponible{" "}
            <Link href="/hazardous-locations" className="font-semibold text-brand-400">en anglais</Link>.
          </p>
        </Container>
      </section>
    </>
