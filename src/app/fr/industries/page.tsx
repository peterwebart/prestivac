...
const description =
  "Guides par secteur : le profil de poussière de votre industrie, son contexte réglementaire, et les guides de matières et d\u2019opérations qui s\u2019y appliquent.";

export const metadata: Metadata = {
  title: "Industries | Guides de récupération par secteur",
  description,
  alternates: {
    canonical: "/fr/industries",
    languages: { "en-US": "/industries", "fr-CA": "/fr/industries" },
  },
  openGraph: { url: "/fr/industries", title: "Industries", description, locale: "fr_CA" },
};

export default function FrIndustriesIndex() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...subpageJsonLd({ name: "Industries", description, path: "/fr/industries" }),
            inLanguage: "fr-CA",
          }).replace(/</g, "\\u003c"),
        }}
      />
      <section className="bg-graphite-950 pb-14 pt-24 lg:pt-28">
        <Container>
          ...
          <p className="mt-10 max-w-3xl text-[13px]/[1.7] text-white/50">
            ...
            disponible{" "}
            <Link href="/industries" className="font-semibold text-brand-400">en anglais</Link>.
          </p>
        </Container>
      </section>
    </>
