import { Droplets, Filter, Flame, ShieldCheck } from "lucide-react";

import type { MaterialGuideData } from "@/components/templates/material-guide";

export const zirconiumDustGuide: MaterialGuideData = {
 slug: "zirconium-dust",
 name: "Zirconium Dust",
 ...
 badges: [
 { icon: Flame, title: "Extremely Pyrophoric", detail: "Among the lowest ignition energy" },
 { icon: Droplets, title: "Often Kept Wet", detail: "Reduces ignition during handling" },
 { icon: Filter, title: "HEPA & Sealed", detail: "Fine reactive fines contained" },
 { icon: ShieldCheck, title: "Built for Metals", detail: "Nuclear, chemical & aerospace" },
 ],
 facts: [
 { label: "Pyrophoricity", value: "Fine zirconium is highly pyrophoric — it can ignite spontaneously on contact with air" },
 { label: "Ignition energy", value: "Among the lowest of any metal dust — very small sparks or static can ignite it" },
 { label: "Handling", value: "Fine zirconium is often kept wet or submerged during handling to reduce ignition risk" },
 { label: "Fire class", value: "A burning zirconium fire is a Class D metal fire — water is dangerous on the fire itself" },
 ],
 overview: [
 ...
 configuration: [
 { step: "Collection tool", detail: "Floor and crevice tools for zirconium machining and grinding fines" },
 { step: "Static-dissipative hose", detail: "Bonded, conductive path end to end — critical for so low an ignition energy" },
 { step: "Recovery unit matched to the metal", detail: "Rated for a highly ignition-sensitive combustible metal" },
 { step: "Wet-handling where practiced", detail: "Fines kept wet to reduce pyrophoric ignition during recovery" },
 { step: "Sealed collection & Class D provisions", detail: "Contained; metal-fire measures in place, water away from any fire" },
 ],
 bestPractices: [
 ...
 faqs: [
 {
 question: "Is zirconium flammable?",
 answer:
 ...
 {
 question: "Why is zirconium considered so dangerous?",
 answer:
 ...
 {
 question: "Should zirconium be kept wet or dry?",
 answer:
 ...
 {
 question: "Where does zirconium dust come from?",
 answer:
 ...
 {
 question: "How is a zirconium fire handled?",
 answer:
